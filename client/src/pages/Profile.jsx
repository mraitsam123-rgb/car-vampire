              ...
              <div className="pb-2 flex-1 flex flex-col justify-end">
                <div className="flex items-center gap-3">
                  ...
                  <span className="bg-yellow-100 text-yellow-800 text-[10px] px-2 py-0.5 rounded-full font-black tracking-widest uppercase border border-yellow-200">
                    Original ({profileUser?.createdAt ? new Date(profileUser.createdAt).toLocaleDateString('en-GB', {day:'numeric', month:'long', year:'numeric'}) : (userAds[0]?.sellerId?.createdAt ? new Date(userAds[0]?.sellerId?.createdAt).toLocaleDateString('en-GB', {day:'numeric', month:'long', year:'numeric'}) : new Date().toLocaleDateString('en-GB', {day:'numeric', month:'long', year:'numeric'}))})
                  </span>
                </div>
